...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> _sendMessage(ChatMessage chatMesssge) async {
    if (chatMesssge.medias?.isNotEmpty ?? false) {
      if (chatMesssge.medias!.first.type == MediaType.image) {
        Message message = Message(
          senderID: chatMesssge.user.id,
          content: chatMesssge.medias!.first.url,
          messageType: MessageType.Image,
          sentAt: Timestamp.fromDate(chatMesssge.createdAt),
        );
    ...
    return IconButton(
      onPressed: () async {
        ...
        if (file != null) {
          ...
          String? downloadURL = await _storageService.ulploadImageToChat(
            file: file,
            chatID: chatID,
          );
