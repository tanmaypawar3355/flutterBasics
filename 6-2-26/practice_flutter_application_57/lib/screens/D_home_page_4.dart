...
import 'package:practice_flutter_application_57/models/D_home_page_4.dart';
...
class _HomePage4State extends State<HomePage4> {
  late Future<List<NestedModel>?> futureBuilder;

  @override
  void initState() {
    super.initState();
    futureBuilder = nestedAPI();
  }

  List<NestedModel> myList = [];

  Future<List<NestedModel>?> nestedAPI() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (var i in data) {
        myList.add(NestedModel.fromJson(i));
      }
      return myList;
    }
    return null;
